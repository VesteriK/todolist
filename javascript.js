...
function removeItem() {
  ...
  setTimeout(function() { 
    item.parentNode.removeChild(item);}, 600);
}
...
function completeItem() {
  ...
  if (id === 'todo') {
    ...
    item.getElementsByClassName('check')[0].getElementsByTagName('img')[0].src = 'resources/check2.png';
  } else {
    data.complete.splice(data.complete.indexOf(value), 1);
    data.todo.push(value);
    item.getElementsByClassName('check')[0].getElementsByTagName('img')[0].src = 'resources/check.png';
